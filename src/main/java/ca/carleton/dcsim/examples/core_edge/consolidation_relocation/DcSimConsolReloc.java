...
public final class DcSimConsolReloc extends GenericSimulationTask {

  private static final String epa = "epa (short const pulse 0.9)";

  public static void main(String args[]) throws IOException {
    GenericSimulationTask.executeTestcases(DcSimConsolReloc.class);
  }

  public DcSimConsolReloc(String name,
                          long seed,
                          LqnGraph lqnModel,
                          long simTime) {
