...
public final class DcSimStatic extends GenericSimulationTask {

  private static final String epa = "epa (const pulse 0.9)";

  public static void main(String args[]) throws IOException {
    GenericSimulationTask.executeTestcases(DcSimStatic.class);
  }

  public DcSimStatic(String name,
                     long seed,
                     LqnGraph lqnModel,
                     long simTime) {
  ...
  protected List<Application> createApplications(SaviCloudNetwork saviNetwork,
                                                 LqnGraph lqnModel) {
    return createInteractiveApplication(simulation, epa, lqnModel);
  }
