...
/**
 * SimulationTaskWrapper wraps a simulation task for execute in order to act as the sole reference
 * to the task, allowing task memory to be freed once it has been run.
 *
...
public class SimulationTaskWrapper extends SimulationTask {
  ...
  public void setRandomSeed(long seed) {
    if (task != null) {
      ...
      throw new IllegalStateException(
          "Attempted to set the random seed of a DCSimulationTaskWrapper that contains no task (or is complete)");
    }
  }
  ...
  public void setMetricRecordStart(long start) {
    if (task != null) {
      ...
      throw new IllegalStateException(
          "Attempted to set the metric record start of a DCSimulationTaskWrapper that contains no task (or is complete)");
    }
  }
  ...
  public SimulationMetrics getMetrics() {
    if (metrics == null) {
      throw new IllegalStateException(
          "Attempted to get results from DCSimulationTaskWrapper which has not executed a task");
    }
