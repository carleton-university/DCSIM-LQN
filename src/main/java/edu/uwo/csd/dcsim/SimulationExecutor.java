...
public class SimulationExecutor {
  ...
  private Logger logger = Logger.getLogger(SimulationExecutor.class);

  private List<SimulationTask> tasks = new ArrayList<SimulationTask>(); //the tasks to execute
  ...
  private List<SimulationTask> execute(ExecutorService executorService) {
    ...
    //shutdown all threads (otherwise they will be cached to await further tasks)
