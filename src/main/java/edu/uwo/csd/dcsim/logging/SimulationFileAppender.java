...
public class SimulationFileAppender extends FileAppender {
  ...
  public SimulationFileAppender(Layout layout, String filename, boolean append, boolean bufferedIO,
  ...
  private String getNewLogFileName() {
    if (fileName != null) {
      ...
      if (dateMarker != -1) {
        fileName =
            fileName.substring(0, dateMarker) + timeStamp + fileName.substring(dateMarker + 2);
      }
      ...
      if (simNameMarker != -1) {
        fileName =
            fileName.substring(0, simNameMarker) + simName + fileName.substring(simNameMarker + 2);
      }
