  ...
  public void recordApplicationMetrics(Collection<Application> applications) {
    ...
    List<Application> filtered = applications
        ...
        .filter(
            a -> (!(a instanceof VmmApplication) &&
                  ...
                  (simulation.getSimulationTime() - a.getActivateTimeStamp() >= appSlaGraceTime)
            ))
    ...
    for (Application application : filtered) {
      ...
      if (application instanceof InteractiveApplication) {
        ...
        final double finalCurrentResponseTime = currentResponseTime;
        // TODO

//        simulation.getSimDataLogger()
//            .ifPresent(logger -> logger.writeResponseTime(simulation.getSimulationTime(),
//                                                          finalCurrentResponseTime));
    ...
    if (interactiveApplications != 0) {
      aggregateResponseTime.add(
          currentResponseTime / interactiveApplications, simulation.getElapsedTime());
      aggregateThroughput.add(
          currentThroughput / interactiveApplications, simulation.getElapsedTime());
    }
  }
  ...
  public List<Pair<String, Object>> getMetricValues() {
    ...
    metrics.add(new ImmutablePair<String, Object>(
        "cpuUnderprovision",
        Utility.roundDouble(Utility.toPercentage(
                                getAggregateCpuUnderProvision().getSum() /
                                getAggregateCpuDemand().getSum()),
                            Simulation.getMetricPrecision())));

    metrics.add(new ImmutablePair<String, Object>("slaAchieveGTE99", Utility
        .roundDouble(getSlaAchievementCountGTEValue(0.99), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveGTE95", Utility
        .roundDouble(getSlaAchievementCountGTEValue(0.95), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveGTE90", Utility
        .roundDouble(getSlaAchievementCountGTEValue(0.9), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveLT90", Utility
        .roundDouble(getSlaAchievementCountLTValue(0.9), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveMean", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getMean()),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveStdev", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getStandardDeviation()),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveMax", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getMax()),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieve95", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getPercentile(95)),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieve75", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getPercentile(75)),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieve50", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getPercentile(50)),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieve25", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getPercentile(25)),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAchieveMin", Utility
        .roundDouble(Utility.toPercentage(getSlaAchievementStats().getMin()),
                     Simulation.getMetricPrecision())));

    metrics.add(
        new ImmutablePair<String, Object>("slaAggregateTotal",
                                          (long) getAggregateSlaPenalty().getSum()));
    metrics.add(new ImmutablePair<String, Object>("slaAggregateMax", Utility
        .roundDouble(getAggregateSlaPenalty().getMax(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAggregateMean", Utility
        .roundDouble(getAggregateSlaPenalty().getMean(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaAggregateMin", Utility
        .roundDouble(getAggregateSlaPenalty().getMin(), Simulation.getMetricPrecision())));

    metrics.add(new ImmutablePair<String, Object>("slaApplicationMean", Utility
        .roundDouble(getSlaPenaltyStats().getMean(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplicationStdev", Utility
        .roundDouble(getSlaPenaltyStats().getStandardDeviation(),
                     Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplicationMax", Utility
        .roundDouble(getSlaPenaltyStats().getMax(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplication95", Utility
        .roundDouble(getSlaPenaltyStats().getPercentile(95), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplication75", Utility
        .roundDouble(getSlaPenaltyStats().getPercentile(75), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplication50", Utility
        .roundDouble(getSlaPenaltyStats().getPercentile(50), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplication25", Utility
        .roundDouble(getSlaPenaltyStats().getPercentile(25), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("slaApplicationMin", Utility
        .roundDouble(getSlaPenaltyStats().getMin(), Simulation.getMetricPrecision())));

    metrics.add(new ImmutablePair<String, Object>("responseTimeMax", Utility
        .roundDouble(getAggregateResponseTime().getMax(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("responseTimeMean",
                                                  getAggregateResponseTime().getMean()));
    metrics.add(new ImmutablePair<String, Object>("responseTimeMin", Utility
        .roundDouble(getAggregateResponseTime().getMin(), Simulation.getMetricPrecision())));

    metrics.add(new ImmutablePair<String, Object>("throughputMax", Utility
        .roundDouble(getAggregateThroughput().getMax(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("throughputMean", Utility
        .roundDouble(getAggregateThroughput().getMean(), Simulation.getMetricPrecision())));
    metrics.add(new ImmutablePair<String, Object>("throughputMin", Utility
        .roundDouble(getAggregateThroughput().getMin(), Simulation.getMetricPrecision())));

    metrics.add(new ImmutablePair<String, Object>("applicationsSpawned", getApplicationsSpawned()));
    metrics
        .add(new ImmutablePair<String, Object>("applicationsShutdown", getApplicationsShutdown()));
    metrics.add(
        new ImmutablePair<String, Object>("applicationPlacementsFailed",
                                          getApplicationPlacementsFailed()));
    metrics.add(new ImmutablePair<String, Object>("averageSize", Utility
