...
public abstract class Policy {
  ...
  private List<Class<? extends ManagerCapability>> requiredCapabilities = new ArrayList<>();
  ...
  public final <T extends Event> boolean execute(T e, AutonomicManager manager) {
    ...
    this.simulation =
        e.getSimulation(); //available through event anyways, but this is a bit more clear
