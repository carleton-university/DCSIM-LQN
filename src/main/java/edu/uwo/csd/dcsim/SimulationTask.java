...
/**
 * SimulationTask represents a single configuration and execution of a simulation. The setup()
 * method should be overridden and written to setup and configure the simulation.
 *
...
public abstract class SimulationTask implements Runnable {
   ...
   *
   * @param name     The name of the simulation task. This can be any name, and is for human
   *                 reference.
  ...
  public SimulationMetrics getMetrics() {
    if (!complete) {
      throw new IllegalStateException(
          "Simulation task results cannot be obtained until the task has been run");
    }
