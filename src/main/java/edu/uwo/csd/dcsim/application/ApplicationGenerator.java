...
/**
 * The ApplicationGenerator class generates new Applications and submits them to a data centre based
 * on given parameters.
 *
...
public abstract class ApplicationGenerator implements SimulationEventListener {
  ...
  public ApplicationGenerator(Simulation simulation, AutonomicManager dcTarget,
                              List<Pair<Long, Double>> applicationsPerHour) {
    ...
    public void eventCallback(Event e) {
      ...
      if (!placementEvent.isFailed()) {
        ...
        if (lifespanDist != null) {
          ...
          simulation.sendEvent(new ShutdownApplicationEvent(ApplicationGenerator.this, application),
