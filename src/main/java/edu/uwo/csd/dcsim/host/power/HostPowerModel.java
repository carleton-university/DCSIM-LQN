...
/**
 * HostPowerModel determines the current power consumption level of a Host. All HostPowerModel
...
public interface HostPowerModel {
  ...
  /**
   * Calculates the power consumption of a Host, in Watts, given that the host is in the ON state
   * and has the specified CPU utilization
   */
