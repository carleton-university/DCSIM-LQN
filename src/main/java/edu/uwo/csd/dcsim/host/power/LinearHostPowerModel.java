...
/**
 * LinearHostPowerModel models Host power consumption as a linear function starting from a fixed
 * consumption at idle CPU and scaling linearly with CPU utilization to a maximum power consumption
 * level.
 *
